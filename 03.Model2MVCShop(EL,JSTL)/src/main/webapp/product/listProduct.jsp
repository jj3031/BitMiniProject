	...
	<tr>
		<td align="right">
			<select name="searchCondition" class="ct_input_g" style="width:80px">
				<option value="0" <%=(searchCondition.equals("0") ? "selected" : "")%>>선택</option>
				<option value="1" <%=(searchCondition.equals("1") ? "selected" : "")%>>상품번호</option>
				<option value="2" <%=(searchCondition.equals("2") ? "selected" : "")%>>상품명</option>
				<option value="3" <%=(searchCondition.equals("3") ? "selected" : "")%>>가격</option>				
			</select>
